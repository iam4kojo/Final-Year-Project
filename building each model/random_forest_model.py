...
model_rf.fit(X_train_resampled,y_train_resampled) # Using the processed data resulted in better values for the ROC AUC Score and same values for everything else
# predictions
...
roc_auc = roc_auc_score(yTest, model_rf.predict_proba(xTest)[:, 1])
